...
import ruleeConfigVue from './rule-configs/vue.js';
...
class App extends React.Component {
        ...
        return (
            <pre className="language-javascript site-code">
                <code dangerouslySetInnerHTML={{
                    __html: test.good.replace(/(\/\/ |\-\-<\/span> )(good)/g, '$1<span class="bg-success text-inverse site-code-tag">$2</span>')
                }}></code>
            </pre>
        );
    }
    renderRuleTestBad(test) {
        ...
        return (
            <pre className="language-javascript site-code">
                <code dangerouslySetInnerHTML={{
                    __html: test.bad.replace(/(\/\/ |\-\-<\/span> )(bad)/g, '$1<span class="bg-danger text-inverse site-code-tag">$2</span>')
                }}></code>
            </pre>
        );
    }
    ...
    render() {
        return (
            <div>
                <GitHubCorners href="https://github.com/erha19/eslint-config-weex" />
                {this.renderHeader()}
                <div className="flex-center">
                    <div className="container-fluid">
